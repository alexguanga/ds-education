...
def simple_heuristic():
    file_path = '/Users/alexguanga/all_projects/Project_Python/DATAScience/Udacity_IntroDataScience/Lesson2/train.csv'
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        #### FIRST EXAMPLE
        '''if ((passenger['Sex'] == 'female') or (passenger['Age'] < 12) or (passenger['Pclass'] == 1)):
            predictions[passenger_id] = 1
    ...
    titantic_data = pd.read(file_path)

    #df = sm.datasets.get_rdataset("titantic").data
    #y, X = dmatrices('Survived ~ Pclass + Age  + Parch + Ticket + Fare', data=df, return_type='dataframe')
